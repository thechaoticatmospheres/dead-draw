...
const rules = {
  ...
  keno: "Pick 2–8 distinct numbers from 1–80. Twenty unique balls are drawn without replacement. The paytable shows total return including the stake. Unlisted match counts lose. Your ticket stays selected for the next draw. All ticket sizes return approximately 85% of chips on average before equipment and comps; individual draws vary widely. Whole-chip returns round down.",
